...
class newsletter_issue3 extends Response {
	...
	async run(message) {
        const newEmbed = new EmbedBuilder()
            ...
            .setColor("#00a368")
            .setImage("https://cdn.discordapp.com/attachments/982439487047077969/1013678960753778728/SA_Newsletter_Final.jpg")
            .setTimestamp()
            .setFooter({ text: 'Article Credits: Akagi, Noodle, Renvi, Silver, Slug, Valerian, Venfei, and Zen <3' })

        message.channel.send("<@&959723574669742131>")

		message.channel.send({ embeds: [newEmbed] })

        message.channel.send({ files: ["https://aggie.io/api/share/3c9e5c63a8.png", "https://aggie.io/api/share/480e9b7e2c.png"] })
	}
}

export default newsletter_issue3