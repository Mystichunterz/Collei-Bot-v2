...
class newsletter_issue5 extends Response {
	...
	async run(message) {
        const newEmbed = new EmbedBuilder()
            ...
            .setColor("#00a368")
            .setImage("https://cdn.discordapp.com/attachments/959712273373478962/1025287265133543454/IMG_4725.jpg")
            .setTimestamp()
            .setFooter({ text: 'Article Credits: Akagi, Noodle, Renvi, Silver, Slug, and Valerian <3' })
